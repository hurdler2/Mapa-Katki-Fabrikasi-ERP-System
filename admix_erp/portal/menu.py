...
MENU: list[dict] = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"label": "8-Part Gate'ler", "url": "portal:gate_list",
             "icon": "🚪",
             "perms": ["gates.view_gate"]},
            {"label": "Integrated Master Register", "url": "portal:master_integrated_list",
             "icon": "📚",
             "perms": ["master_register.view_integratedeventregister"]},
            {"label": "Security Event Register", "url": "portal:master_security_list",
             "icon": "🛡️",
             "perms": ["master_register.view_securityeventregister"]},
            {"label": "Kural İhlalleri", "url": "portal:violation_list",
             "icon": "⚖️",
             "perms": ["rules.view_ruleviolation"]},
            {"label": "12 Kural Kataloğu", "url": "portal:rules_catalog",
             "icon": "📜",
             "perms": ["rules.view_ruleviolation"]},
        ],
    },
